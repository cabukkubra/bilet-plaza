<header class="col-sm-12 shadow-header-other-page mobile-none">
	<div class="container p-0">
		<nav class="navbar navbar-expand-lg navbar-light bg-orange headermenu p-0">
			<a href="index.php" class="col-sm-2 p0 logo p-0 mobile-logo">
				...
				<div class="navbar-nav my-2 my-lg-0">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							...
							<a class="nav-link fontsize-14 sign-up pl-pr-0" href="#" data-toggle="modal" data-target=".bd-example-modal-lg">
								<i class="fas fa-user mr-1"></i> Giriş Yap / Üye Ol
							</a>
...
<div class="mobile-menu-bar">
	...
	<div class="tablet-menu">
		<div class="outer-menu sabitmenu fadeIn animated">
			<a href="" class="mobil-logo desktop-none">
				<img src="assets/img/biletplaza.png" alt="Bilet Plaza">
			</a>
