...
<body>
    ...
    <div class="container mobile-container">
        ...
        <div class="row clearfix payment">
            <div class="col-md-5">
                <div class="white-box box-shadow-50 mb-4 pd-lr-40">
                    <div class="box-sefer">
                        <div class="title-payment blue-text">SEFER BİLGİLERİ</div>
                        <table cellspacing="0" cellpadding="0" border="0" class="blue-text">
                         <tr>
                            <td align="left" width="50%">
                               <span class="bx-sefer-move">KALKIŞ</span>
                               <span class="bx-sefer-city">İZMİR</span>
                               <span class="bx-sefer-time">03:45</span>
                               <span class="bx-sefer-date">22.11.2019</span>
                           </td>
                           <td align="center">
                               <i class="fas fa-angle-right" style="font-size: 50px; color: #3D517D;"></i>
                           </td>
                           <td align="right" width="50%">
                               <span class="bx-sefer-move">VARIŞ</span>
                               <span class="bx-sefer-city">İSTANBUL</span>
              ...
              <div id="accordion">
                <div class="panel checkout-step">
                    ...
                    <div id="collapseOne" class="collapse in show">
                        ...
                        <input type="text" class="form-control" placeholder="Pasaport No">
                        <input type="text" class="form-control" placeholder="Servis Seçiniz">
                    </div>
                </div>
    ...
    <div class="col-md-7">
        <div class="payment clearfix radius5 mb-4">
            <div class="mb-4">SEÇİLEN KOLTUKLAR</div>
            <ul class="chair-list">
                <li class="chair-child" data-toggle="modal" data-target="#chairselectmodal"><a href=""><span>4</span><img src="assets/img/man-chair.svg" width="36"></a></li>
                <li class="chair-child"><a href=""><span>3</span><img src="assets/img/woman-chair.svg" width="36"></a></li>
                <li class="chair-child" data-toggle="modal" data-target="#chairselectmodal"><a href=""><span>4</span><img src="assets/img/man-chair.svg" width="36"></a></li>
                <li class="chair-child" data-toggle="modal" data-target="#chairselectmodal"><a href=""><span>4</span><img src="assets/img/man-chair.svg" width="36"></a></li>
            </ul>
            <div class="total-price-box">
                <span>Toplam Fiyat <strong>( 4 Kişi )</strong></span> <em>150₺</em>
            </div>
        </div>

        <div class="title-payment blue-text mr-4">ÖDEME BİLGİLERİ</div>
        <div class="title-card">Kredi Kartı İle Ödeme</div>				
        <div class="white-box creditcard-box mb-4 clearfix">
            <div class="row">
